...
setup(
       # the name must match the folder name 'verysimplemodule'
        ...
        install_requires=['numpy', 'pandas', 'sklearn', 'setuptools', 'pytest', 'scipy'], 
